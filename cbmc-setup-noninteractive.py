...
from cbmc_starter_kit.setup import litani_definition, project_name_definition, srcdir_definition
...
def cbmc_starter_kit_setup_noninteractive():
    ...
    with open(makefile, "a", encoding='utf-8') as mkfile:
        ...
        print("MEMORY_PROFILING = --profile-memory --profile-memory-interval 1", file=mkfile, end=os.linesep*2)
        print("CBMCFLAGS += --big-endian  --arch sparc", file=mkfile, end=os.linesep*2)
